...
//        String sub_net = request.getParameter("sub_net");
        ...
        server.setServer_net(dynamic_ip+" "+dynamic_ip_mask);
...
//        server.setAllow_private_net(allow_all_access_sub_net);
        ...
        Server default_server = serverDao.find();
        List<PrivateNet> nets = privateNetDao.findAll();
        VPNConfigUtil.configServer(default_server, StringContext.server_config_file,nets);
        json = "{success:true}";
