...
public class ClientVersionAction extends ActionSupport {
    ...
    public String upload() throws IOException {
        ...
        if (os.equals("android"))
            ...
            toSrc = StringContext.systemPath + "/client/linux/cz" + "/" + uploadFileFileName;
        }else if(os.equals("linuxDb")){
            toSrc = StringContext.systemPath + "/client/linux/db" + "/" + uploadFileFileName;
        }
    ...
    public String find() throws Exception {
        ...
        if (win64_info.exists()) {
            win64v = VersionUtils.readInfo(win64_info);
            if (win64v != null) {
                if (win32v != null||av!=null)
                    sb.append(",");
                sb.append("{");
                sb.append("version:'" + win64v.getVersion() + "',");
                sb.append("name:'" + win64v.getName() + "',");
                sb.append("os:'win64'");
                sb.append("}");
            }
        }
        ...
        if (liunxCz_info.exists()) {
            liunxCzv = VersionUtils.readInfo(liunxCz_info);
            if (liunxCzv != null) {
                if (win64v != null||win32v != null||av!=null)
                    sb.append(",");
                    sb.append("{");
                    sb.append("version:'" + liunxCzv.getVersion() + "',");
                    sb.append("name:'" + liunxCzv.getName() + "',");
        ...
        if (liunxDb_info.exists()) {
            Version liunxDbv = VersionUtils.readInfo(liunxDb_info);
            if (liunxDbv != null) {
                if (liunxCzv!=null||win64v != null||win32v != null||av!=null)
                    sb.append(",");
                sb.append("{");
                sb.append("version:'" + liunxDbv.getVersion() + "',");
                sb.append("name:'" + liunxCzv.getName() + "',");
                sb.append("os:'linuxDb'");
                sb.append("}");
            }
        }
