...
//        String zyManager = "TOP_ZYGL:SECOND_ZWZY:SECOND_XYZY:";   //资源管理
        String zyManager = "TOP_ZYGL:SECOND_XYZY:";   //资源管理
        String pzManager = "TOP_FWGL:SECOND_FWZT:SECOND_JBPZ:SECOND_ZSPZ:SECOND_SJBJ:";  //服务管理
        String yhManager = "TOP_ZDGL:SECOND_KXZD:SECOND_ZDYH:SECOND_ZDFZ:SECOND_ZDZX:SECOND_ZDRZ:SECOND_ZDJL:";   //终端管理
