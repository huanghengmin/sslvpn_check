...
import com.hzih.sslvpn.web.action.sslvpn.acl.ACLXML;
...
//        sb.append("max-clients " + max).append("\n");
        ...
        /*if (ACLXML.getAttribute(ACLXML.proxy_ip) != null)
            sb.append("bs-proxy-ip " + ACLXML.getAttribute(ACLXML.proxy_ip)).append("\n");

        if (ACLXML.getAttribute(ACLXML.proxy_port) != null)
            sb.append("bs-proxy-port " + ACLXML.getAttribute(ACLXML.proxy_port)).append("\n");

        if (ACLXML.getAttribute(ACLXML.url) != null)
            sb.append("auth-url " + ACLXML.getAttribute(ACLXML.url)).append("\n");

        if (ACLXML.getAttribute(ACLXML.status) != null && ACLXML.getAttribute(ACLXML.status).equalsIgnoreCase("1"))
            sb.append("auth-flag   true").append("\n");
        else
            sb.append("auth-flag   false").append("\n");

        if (ACLXML.getAttribute(ACLXML.port) != null)
            sb.append("proxy-port " + ACLXML.getAttribute(ACLXML.port)).append("\n");*/
