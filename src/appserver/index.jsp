    ...
    <script type="text/javascript">
        ...
        Ext.onReady(function () {
            ...
            var mrn_4_4 = new Ext.tree.TreeNode({
                ...
                text: '审计配置',
                leaf: true,
                url: 'pages/audit/audit_flag.jsp'
            });
           ...
           /* var mrn_6_1 = new Ext.tree.TreeNode({
            ...
            var mrn_7_4 = new Ext.tree.TreeNode({
                ...
                text: '数据标记',
                leaf: true,
                url: 'pages/server_config/datamarker.jsp'
            });
...
//                contentEl: 'top-div',		//面板包含的内容
                ...
                height: 86,
                html:'<div id="top" style="border:1px solid #564b47;background-color:#fff;height:55;width:100%;background-image: url(img/topVPN_CX_V2.0.jpg);">' +
