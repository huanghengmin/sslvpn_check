    ...
    var formPanel = new Ext.form.FormPanel({
        ...
        items: [
            ...
            },
            {
                ...
                items: [
                    {
                        boxLabel: '禁用', id: 'bluetooth.terminal', inputValue: 1, name: 'bluetooth'
                    }
                ]
            },
            {
                ...
                items: [
                    {
                        boxLabel: '禁用', id: 'wifi.terminal', inputValue: 1, name: 'wifi'
                    }
                ]
            },
            {
                ...
                items: [
                    {
                        boxLabel: '禁用', id: 'gprs.terminal', inputValue: 1, name: 'gprs'
                    }
                ]
            }
        ],
