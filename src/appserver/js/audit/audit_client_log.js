...
function show_type(value) {
    if (value == "002") {
        return '<span style="color:green;">用户鉴别失败</span>';
    } else if (value == "003") {
        return '<span style="color:green;">授权用户一般操作</span>';
    } else if (value == "005") {
        return '<span style="color:green;">VPN隧道的建立与删除</span>';
    } else if (value == "006") {
        return '<span style="color:green;">同一VPN隧道的建立与删除</span>';
    } else if (value == "007") {
        return '<span style="color:green;">用户数据完整性校验失败</span>';
    } else if (value == "008") {
        return '<span style="color:green;">用户数据解密失败</span>';
    } else if (value == "009") {
        return '<span style="color:green;">根据策略,数据包被丢弃</span>';
    } else if (value == "011") {
        return '<span style="color:green;">重放攻击</span>';
    }
};
